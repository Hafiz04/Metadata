...
|computer.jpg|strings|https://www.dcode.fr/strings-extractor|![image alt]()|Extracts all readable text (strings) from a file, similar to the Linux strings command|
|solitaire.jpg|file|
|rubiks.jpg|file|
