...
|Computer.jpg|Hexeditor|https://hexed.it/||raw binary data of computer.jpg interpreted as different number formats. The hex editor is showing you how those bytes can be read|
|dog.jpg|binwalk|
